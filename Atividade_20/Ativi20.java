...
public class Ativi20 {
    ...
    public static void main(String[] args) {
        ...
        if (number1 > number3 && number2>number3)
            System.out.println("O terceiro número: "+number3+", foi o menor");
        else if (number1 > number2 && number3>number2 )
            System.out.println("O segundo número: "+number2+", foi o menor");
        else
            System.out.println("O primeiro número: "+number1+", foi o menor");
    }
